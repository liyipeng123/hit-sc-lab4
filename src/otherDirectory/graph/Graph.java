...
public interface Graph<L> {
    ...
    /**
     * get the distance from two points in the graph
     *
     * @param source the point1
     * @param target the point2
     * @return the distance between the two points
     */
    int getDistance(L source, L target);
     ...
     */
    void removeEdge(L source, L target);
